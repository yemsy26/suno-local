...
- **Dicción Española Pura:** Se utiliza el motor **ACE-Step**, inyectándole etiquetas estrictas `[es]` por debajo del capó tras limpiar toda la basura del LLM, garantizando acentos latinos nativos sin el fallo robótico de otros modelos generativos.
